(function(){
  ...
  .directive('encabezadopassrecovery', encabezadopassrecovery);
...
encabezadopassrecovery.$inject = [];
function encabezadopassrecovery(){
  return {
    scope:{},
    templateUrl: 'app/header/headerpassrecovery.html',
    controller:'LoginController',
    controllerAs:'vm'
};
}
